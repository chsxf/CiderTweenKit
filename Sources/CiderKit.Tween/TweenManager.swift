...
public actor TweenManager: GlobalActor {
    ...
    /// Starts the `TweenManager` by getting a `CADisplayLink` instance from an `NSView`
    ///
    ...
    /// Starts the `TweenManager` by getting a `CADisplayLink` instance from an `NSWindow`
    ///
